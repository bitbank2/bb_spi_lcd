...
enum
{
    ...
    DISPLAY_CYD_C5, // NM-CYD-C5 (2.8" ST7789 ESP32-C5)
    ...
    DISPLAY_ELECROW_P4_800x480, // RGB panel
    DISPLAY_ELECROW_S3_800x480, // RGB panel
    ...
    DISPLAY_WS_AMOLED_216, // Waveshare 480x480 2.16" AMOLED square
    ...
    DISPLAY_LILYGO_T_DECK_PLUS, // 2.8" 320x240 
    DISPLAY_LILYGO_T_PAGER, // 2.84" 480x222
...
enum {
   ...
   LCD_ST7735_128B, // 128x128 Waveshare RPI HAT
   LCD_SSD1331,
   LCD_SSD1351,
   ...
   LCD_CO5300, // 280x456 1.64" AMOLED QSPI
   LCD_CO5300B, // 460x460 2.0" AMOLED QSPI
   LCD_CO5300C, // 480x480 2.16" AMOLED QSPI
   ...
   LCD_ST77916B, // 360x360 round 1.53" QSPI variant

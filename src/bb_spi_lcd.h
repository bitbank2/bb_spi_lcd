...
public:
	...
	int begin(int iStandardType, bool bSkipInit = false);
...
enum
{
	...
	DISPLAY_UM_SQUARE,		 // Unexpected Maker Square DIsplay 480x480
	DISPLAY_WAVESHARE,		 // Waveshare ESP32-S3-LCD-Driver-Board
	DISPLAY_COUNT
};
